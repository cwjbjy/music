...
var _musicPlay = _interopRequireDefault(__webpack_require__(/*! ./pages/musicPlay/musicPlay.vue */ 78));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
/* harmony import */ var _musicPlay_vue_vue_type_template_id_a81d220c_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./musicPlay.vue?vue&type=template&id=a81d220c&scoped=true& */ 79);
/* harmony import */ var _musicPlay_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./musicPlay.vue?vue&type=script&lang=js& */ 81);
...
/* harmony import */ var _musicPlay_vue_vue_type_style_index_0_id_a81d220c_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./musicPlay.vue?vue&type=style&index=0&id=a81d220c&lang=scss&scoped=true& */ 83);
...
var render = function() {
  ...
  var f0 = _vm.songs.length > 0 ? _vm._f("author")(_vm.song.ar) : null
  var f1 = _vm.songs.length > 0 ? _vm._f("palyTime")(_vm.current) : null
  var f2 = _vm.songs.length > 0 ? _vm._f("palyTime")(_vm.duration) : null
...
var _default =
{
  ...
  onLoad: function onLoad(options) {var _this = this;return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee() {var _yield$_this$$API, data;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:
              ...
              /* 获取歌曲详情 */
              _this.$API({
                url: "/song/detail?ids=".concat(_this.id) }).
              then(function (res) {
                _this.songs = res.data.songs;
                _this.song = _this.songs[0];
              });
              /* 判断是否有播放该歌曲权限 */_context.next = 4;return (


                _this.$API({
                  url: "/check/music?id=".concat(_this.id) }));case 4:_yield$_this$$API = _context.sent;data = _yield$_this$$API.data;

              if (data.success) {
                _this.$API({
                  url: "/song/url?id=".concat(_this.id) }).
                then(function (res) {
  ...
  methods: {
    ...
    paly: function paly() {var _this2 = this;return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee2() {return _regenerator.default.wrap(function _callee2$(_context2) {while (1) {switch (_context2.prev = _context2.next) {case 0:
                _this2.palyStatus = !_this2.palyStatus;
                if (_this2.palyStatus) {
                  _this2.audio.play();
                } else {
                  _this2.audio.pause();
                }
                _this2.audio.onPlay(function () {
                  console.log('开始播放');
                  console.log('长度', _this2.audio.duration);
                  console.log('位置', _this2.audio.currentTime);
                  console.log('播放状态', _this2.audio.paused);
                });
                _this2.audio.onError(function (res) {
